...
class ThaiBasicSpellChecker(object):
...
class ThaiEngTokenNormalizer(PipeRunner):
    """Will normalize all tokens in a spacy document.
    2 different pathways for Thai and English tokens (token._.lang is 'th' = Thai or 'en' = English)
